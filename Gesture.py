...
while(True):
    ...
    # znajdywanie reki zdefiniowane poprzez kolory hsv
    ...
    if l == 1:
        if areacnt < 2000:
            ...
            if arearatio < 12:
                cv2.putText(frame, 'Piąstka', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)


    elif l == 2:
        cv2.putText(frame, 'Pokoj', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)

    elif l == 5:
        cv2.putText(frame, 'Piatka', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
